...
#### What's New
- Rename a task using the context menu
- Extract a subtask using the context menu
- Show project status settings by tapping/clicking on its name
- Moving statuses within a project in list mode
